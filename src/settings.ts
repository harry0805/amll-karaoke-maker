...
export function validateSettings(input: unknown): Settings {
  ...
  const s = { lineSpacing: defaults.lineSpacing, horizontalMargin: defaults.horizontalMargin, textColor: defaults.textColor, duetColor: defaults.duetColor, font: defaults.font, outlineColor: defaults.outlineColor, outlineWidth: defaults.outlineWidth, ...input } as Settings;
  ...
  return { fontSize: s.fontSize, lineSpacing: s.lineSpacing, bottom: s.bottom, horizontalMargin: s.horizontalMargin, height: s.height, offset: s.offset, shade: s.shade, textColor: s.textColor, duetColor: s.duetColor, font: s.font, outlineColor: s.outlineColor, outlineWidth: s.outlineWidth };
}
